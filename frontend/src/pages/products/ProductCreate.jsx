    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                toast.error(response.data.message || 'Tạo sản phẩm thất bại');
            }
        } catch (error) {
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                            ...
                            <div className="flex gap-3">
                                <input
                                    {...register('sku')}
                                    type="text"
                                    className={`flex-1 px-4 py-3.5 bg-gray-50/50 border-2 rounded-xl focus:ring-4 focus:ring-red-500/20 focus:border-red-500 focus:bg-white transition-all duration-300 ${
                        ...
                        <div className="flex justify-end gap-4 pt-6 border-t border-gray-100 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-red-500 via-red-600 to-orange-500 hover:from-red-600 hover:via-red-700 hover:to-orange-600 text-white font-bold rounded-xl shadow-lg shadow-red-500/30 hover:shadow-xl hover:shadow-red-500/40 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                            >
                                {isSubmitting ? (
                                    <>
